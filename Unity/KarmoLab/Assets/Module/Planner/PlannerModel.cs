...
namespace KarmoLab.Module.Planner
{
    ...
    public class TodoItem
    {
        ...
        public string Category; // "personal", "study", "team"
    ...
    public class PlannerData
    {
        ...
        public string TargetDateString = "2027-03-01"; // Default date

        // Customizable Headers (Replaces hardcoded personal info)
