# KarmoEditor Scene Toolbar 개발 결과 보고서

본 문서는 Unity 6.3 버전의 새로운 MainToolbar API를 활용한 KarmoEditor 씬 선택기 개발 과정과 기술적 세부 사항을 정리합니다.

## 1. 개발 개요
유니티 에디터 상단 툴바에 프로젝트 내의 씬을 빠르게 탐색하고 전환할 수 있는 드롭다운 메뉴를 추가하여 작업 효율성을 개선했습니다.

## 2. 주요 기능
- **메인 툴바 통합**: Unity 6.3 정식 `MainToolbar` API를 사용하여 에디터 최상단에 UI 배치.
...
public class ToolbarSceneConfig : ScriptableObject
{
    ...
    public IEnumerable<string> GetTargetScenePaths() { /* 씬 검색 로직 */ }
}
```

#### KarmoToolbar (Static Factory Method Pattern)
공식 샘플에서 권장하는 정적 팩토리 메서드 방식을 사용합니다.
```csharp
...
---
*관련 문서*:
- [SceneToolbar_Design.md](file:///c:/Users/masca/source/repos/_Mascari4615/KarmoLab/Unity/KarmoLab/Doc/KarmoEditor/SceneToolbar_Design.md)
- [Toolbar_Ideas.md](file:///c:/Users/masca/source/repos/_Mascari4615/KarmoLab/Unity/KarmoLab/Doc/KarmoEditor/Toolbar_Ideas.md)
