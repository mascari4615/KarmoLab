...
namespace KarmoLab.KarmoEditor
{
	...
	/*
	 * [기술 참고 사항]
	 * 1. MainToolbarElementAttribute: 정적 메서드에 사용하여 툴바 요소를 등록합니다.
	 * 2. IEnumerable<MainToolbarElement>: 단일 또는 여러 요소를 한 번에 반환할 수 있습니다.
	 * 3. MainToolbarDropdown/MainToolbarButton: 툴바 전용 UI 요소를 사용합니다.
	 * 4. MainToolbar.Refresh(ID): 상태 변경 시 호출하여 툴바 UI를 갱신합니다.
	 */
	public static class KarmoToolbar
	{
		...
		static IEnumerable<MainToolbarElement> CreateSceneSelector()
		{
			...
			var content = new MainToolbarContent(activeScene, "설정된 씬 목록으로 빠르게 이동합니다냥!");
