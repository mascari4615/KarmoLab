 ...
 * 시험도 함께 옮긴다. 그래야 지워졌다를 이 파일 하나가 잡는다.
 *
...
beforeEach(async () => {
  ...
  const UNSAFE = new Set([1719, 1720, 1723, 2049, 3659, 4045, 4190, 5060, 5061, 6000, 6566, 6665, 6666, 6667, 6668, 6669, 6679, 6697, 10080]);
  let port = 0;
...
describe('오늘의 문제 (KL-190 ③)', () => {
  it('우물에서 문제가 나온다. 보기 넷, 정답 글자는 안 실린다', async () => {
    ...
    expect(body.ready).toBe(true); // 건너뛰면 문제가 안 나온다를 초록으로 넘기게 된다
