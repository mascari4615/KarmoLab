...
function bellStyle(): void {
    ...
    style.textContent = [
        ...
        '.kl-bell-head button { background:none; border:0; color:var(--accent-ink); font:inherit; font-size:var(--font-size-3xs); cursor:pointer; }',
        ...
        '.kl-bell-dm[data-on="1"] { color:var(--accent-ink); }',
        ...
        '.kl-bell-tab[aria-pressed="true"] { border-color:var(--accent); color:var(--accent-ink); }',
