...
(function (): void {
  ...
  function ensureStyle(): void {
    ...
    el.textContent = [
      ...
      '@media(min-width:900px){.mc-cols{grid-template-columns:repeat(3,1fr);min-height:calc(100vh - 110px - 48px)}}',
      ...
      '@media(min-width:900px){.mc-dcols{grid-template-columns:400px minmax(0,1fr) 330px;',
      'min-height:calc(100vh - 110px - 48px - 40px)}}',
      ...
      '@media(min-width:900px){.mc-term{max-height:calc(100vh - 110px - 48px - 40px - 300px)}}',
