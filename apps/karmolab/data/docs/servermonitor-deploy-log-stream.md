...
- **deploy** / **npm i** 시 터미널과 비슷하게 **줄 단위** 로그가 카드 하단에 쌓임.
- 긴 작업 중에도 **응답 없음처럼 보이지 않게** 함.
- 실패 시 **마지막까지의 로그**로 원인 파악에 도움을 줌.

## 2. 비목표 (당분간)

- **시작**으로 띄운 백그라운드 프로세스의 장기 로그는 포함하지 않음.
- stdin, PTY(색상, 진행 막대 완벽 재현)는 하지 않음.
