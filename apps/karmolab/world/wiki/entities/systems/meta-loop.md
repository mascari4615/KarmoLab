...
karmoddrine 산하 모든 작업 (WM / KarmoLab / KarmoLab 봇 / 인생, 취미, 학습 등) 이 도는 *메타* 흐름. 모든 다른 시스템의 부모.
...
본 시스템은 *모든 다른 시스템의 부모*. 서브시스템 (WM Quest 흐름 / KL 위젯 빌드 / KarmoLab 봇 캐릭터 시스템 / MDD 등) 은 *이 메타 루프의 어느 노드에 끼는지* 로 표현.
