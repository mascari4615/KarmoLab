/**
 * 실제 사이트에 있어야 하는 것이 있는가 (TASK-KL-089)
 *
 ...
 * 마크업이 나갔나 뿐 아니라 그 모양을 만드는 스타일도 함께 나갔나까지 본다
...
if (!BASE.startsWith('https://')) {
  /* ★ **건너뛴 것은 초록이 아니다** (2026-08-14). 0 으로 끝내면 게이트 화면에 ✓ 로 찍혀
     실사이트 필수 요소가 다 있다로 읽힌다. 실제로는 **한 번도 안 봤다**.
     이 저장소는 2 를 못 돌림으로 읽는다(`run-gates.mjs`). 그렇게 말한다. */
