 ...
 *
 * 이 도구의 주장은 넷이고, 넷 다 그려졌나로는 안 잡힌다:
...
await page.addInitScript(() => {
  ...
  /* 공유 그림을 가로챈다. 이 기계엔 공유 창이 없으니 클립보드 길로 온다.
     받아 낸 바이트 수가 그림이 실제로 만들어졌다의 유일한 증거다. */
  window.__shared = 0;
...
/** 캔버스 하나를 지문 + 색 가짓수로 줄인다. 그렸나와 다시 그렸나를 둘 다 여기서 본다. */
...
/* 무대가 실제로 칠해졌나. 여백의 판이라 색은 적지만 단색(1가지)이면 안 된다. */
 ...
 * 여기서 보려는 것은 10분 뒤의 판이지 그 600초를 다 겪었는가가 아니다. 화면은 지금
